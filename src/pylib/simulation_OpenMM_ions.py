...
def do_openMM_simulation(model_folder, prod_time, frames, GPU_id):
    ...
    additive_ions_Universe = u.select_atoms('name MG')
    ...
    restraintmasks = dict([
        ...
        ('Additive_ions', additive_ions_Universe.atoms.indices),
    ...
    restraintmask_protein = restraintmasks['Protein']
    restraint_ref = inpcrd.positions

    restraintForce_protein = HarmonicRestraint(restraint_wt, restraintmask_protein, restraint_ref)
    restraintForceIndex_protein = system.addForce(restraintForce_protein)

    restraint_wt_add_ions = 0.956 * kilocalorie/mole/angstrom ** 2
    restraintmask_add_ions = restraintmasks['Additive_ions']
    restraint_ref = inpcrd.positions

    restraintForce_add_ions = HarmonicRestraint(restraint_wt_add_ions, restraintmask_add_ions, restraint_ref)
    restraintForceIndex_add_ions = system.addForce(restraintForce_add_ions)
    ...
    system.removeForce(restraintForceIndex_add_ions)
    system.removeForce(restraintForceIndex_protein)
    ...
    restraint_wt = 0.478 * kilocalorie/mole/angstrom ** 2
    restraintmask_add_ions = restraintmasks['Additive_ions']
    restraint_ref = inpcrd.positions

    restraintForce_add_ions = HarmonicRestraint(restraint_wt, restraintmask_add_ions, restraint_ref)
    restraintForceIndex_add_ions = system.addForce(restraintForce_add_ions)
    ...
    restraint_wt_add_ions = 0.239 * kilocalorie/mole/angstrom ** 2
    restraintmask_add_ions = restraintmasks['Additive_ions']  
    restraint_ref = inpcrd.positions
    ...
    restraintmask_sc = restraintmasks['Sidechain']   
    restraint_wt_add_ions = 0.12 * kilocalorie/mole/angstrom ** 2
    restraintmask_add_ions = restraintmasks['Additive_ions']  
    restraint_ref = inpcrd.positions
    ...
    restraintmask_sc = restraintmasks['Sidechain']   
    restraint_wt_add_ions = 0.048 * kilocalorie/mole/angstrom ** 2
    restraintmask_add_ions = restraintmasks['Additive_ions']  
    restraint_ref = inpcrd.positions
    ...
    restraintmask_sc = restraintmasks['Sidechain']  
    restraint_wt_add_ions = 0.012 * kilocalorie/mole/angstrom ** 2
    restraintmask_add_ions = restraintmasks['Additive_ions']   
    restraint_ref = inpcrd.positions
    ...
    Maintain 310.0 K
    Maintain 1 atmospheres
    10 nanoseconds (5000000 steps * 0.002 fs/step)
    snapshots per 100 picoseconds (50000 steps * 0.002 fs/step)
    '''
    # temp = 310.0 * kelvin
    # pressure = 1 * atmospheres
